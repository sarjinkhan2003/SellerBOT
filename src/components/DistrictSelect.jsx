...
function DistrictSelect({ label = "District", selectedDistrict, onSelect, disabled = false }) {
  ...
  useEffect(() => {
    setQuery(selectedDistrict?.name || "")
  ...
  return (
    <label className="relative block">
      ...
      />
      {isOpen && !disabled && (
        <div className="absolute left-0 right-0 z-30 mt-2 max-h-44 overflow-y-auto rounded-md border border-slate-200 bg-white shadow-lg">
